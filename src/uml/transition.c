 ...
 * Trigger.The query isConsistentWith specifies that a redefining Transition is consistent with a redefined
 * Transition provided that the source Vertex of the redefining Transition redefines the source Vertex of the
