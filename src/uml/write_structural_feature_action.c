 ...
 * Description
 * 
 * WriteStructuralFeatureAction is an abstract class
 * for StructuralFeatureActions
 ...
 * 
 * The OutputPin on which is put the
 * input object as modified
 * by the WriteStructuralFeatureAction.
 * 
 *  ♦ value : InputPin [0..1]
 ...
 * ::writeStructuralFeatureAction)
 * 
 * The InputPin that provides the value
 ...
 * 
 * The multiplicity of the result
 * OutputPin must be 1..1.
 * 
 * inv: result <> null implies result.is(1,1)
 * 
 *  type_of_value
 * 
 * The type of the value InputPin
 * must conform to the type of
 * the structuralFeature.
 * 
